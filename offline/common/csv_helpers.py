...
def readCsv(path: str, names=None, skiprows=0, thousands=None, converters=None, encoding=None) -> pd.DataFrame:
    return pd.read_csv(path, index_col=None, names=names, skiprows=skiprows, thousands=thousands, converters=converters, encoding=encoding)
